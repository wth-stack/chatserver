                    ...
                    { // 登陆成功
                        ...
                        if (responsejs.contains("offlinemsg"))
                        {
                            ...
                            for (string &str : vec)
                            {
                                ...
                                {
                                    cout << "群消息[" << js["groupid"] << "]"
                                         << " " << js["time"].get<string>() << "[" << js["id"] << "]" << js["name"].get<string>() << "said: "
                                         << js["msg"].get<string>() << endl;
                                }
                            }
                        }
...
void mainMenu(int clientfd)
{
    ...
    while(ismainMenuRunning)
    {
        ...
        // 调用相应命令的事件处理回调，mainMenu对修改封闭，添加的新功能不需要修改该函数
...
void chat(int clientfd, string str)
{
    ...
    // cout<< str << " " << g_currentUser.getName() <<  " " << friendid << " " << message << endl;
